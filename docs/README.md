...
- [`REVIEW_2026-08-29_INDEPENDENT.md`](REVIEW_2026-08-29_INDEPENDENT.md) —
  актуальное независимое приёмочное ревью и список рекомендаций;
...
- [`SESSION_CONTEXT_2026-08-30.md`](SESSION_CONTEXT_2026-08-30.md) — текущий
  handoff доводки; deployed revision и source HEAD явно разделены.
