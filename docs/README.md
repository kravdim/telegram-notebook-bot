...
Текущий отчёт об исправлениях: [`REMEDIATION_2026-09-07.md`](REMEDIATION_2026-09-07.md).
Он различает локальную проверку рабочей копии, CI, live и deployment.
Основание: [`REVIEW_2026-09-07_COMPREHENSIVE.md`](REVIEW_2026-09-07_COMPREHENSIVE.md).
Состояние прежних релизов не переносится на эти изменения автоматически.
...
- [`SESSION_CONTEXT_2026-09-05.md`](SESSION_CONTEXT_2026-09-05.md) — исторический
...
- [`REMEDIATION_PLAN_2026-09-04.md`](REMEDIATION_PLAN_2026-09-04.md)
  — исторический план исполнения комплексного ревью: этапы, зависимости, проверки,
...
- [`REVIEW_2026-09-04_COMPREHENSIVE_INDEPENDENT.md`](REVIEW_2026-09-04_COMPREHENSIVE_INDEPENDENT.md)
  — историческое комплексное ревью `v0.5.0`: архитектура, корректность, UX,
...
- [`SESSION_CONTEXT_2026-09-03.md`](SESSION_CONTEXT_2026-09-03.md) — предыдущий
  handoff релиза `v0.3.6`;
- [`SESSION_CONTEXT_2026-09-04.md`](SESSION_CONTEXT_2026-09-04.md) — исторический
