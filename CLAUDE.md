...
Разработка ведётся последовательно по этапам. Каждый этап — рабочий инкремент. Подробные инструкции в `docs/stages/stage_XX.md`.
...
2. Начни с этапа 1: `docs/stages/stage_01.md`
3. После завершения каждого этапа — проверь что всё работает, затем переходи к следующему
4. При сомнениях — выбирай более надёжное решение, даже если оно сложнее
