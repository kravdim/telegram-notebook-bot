"""PostgreSQL adapter for persisted multi-step workflow transitions."""

from bot.application.interactions import InteractionPort, WorkflowType
...
interaction_service: InteractionPort = InteractionService()
